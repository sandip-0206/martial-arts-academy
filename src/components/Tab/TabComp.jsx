...
const TabComp = () => {
  ...
  return (
    <>
      <div id="program" className="container my-12 md:my-16">
        {/* Tabs button section */}
        <div className="mb-4">
          {tabs.map((tab) => (
            <button
              ...
              className={`py-2 px-4 my-2 mx-1 rounded ${
                activeTab === tab
          ...
          {filteredCards.map((card) => (
            ...
            >
              <img
                src={card.image}
                alt=""
                className="h-[240px] w-full object-cover rounded-xl hover:scale-105"
              />
